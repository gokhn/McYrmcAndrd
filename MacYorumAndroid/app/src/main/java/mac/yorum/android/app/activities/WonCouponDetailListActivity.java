...
import mac.yorum.android.app.adapters.WonDetailListAdapter;
...
public class WonCouponDetailListActivity extends BaseAppCompatActivitiy {

    RecyclerView mRecyclerView;
    EmptyListAdapter mAdapyerEmpty;
    WonDetailListAdapter mAdapter;
    ...
    private void SetFont()
    {
        ...
        txt_header.setText(getResources().getString(R.string.woncoupon));
    }
    ...
    private void binData(final ArrayList<CouponMatch> items)
    {
        ...
        RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(WonCouponDetailListActivity.this);
        ...
        {
            mAdapter = new WonDetailListAdapter(WonCouponDetailListActivity.this, items);
        ...
        servicecall.enqueue(new Callback<LoginResponse>() {
            ...
            public void onResponse(Call<LoginResponse> call, retrofit2.Response<LoginResponse> response)
            {
                try
                {
                    ...
                    {
                        hideLoadingPopup();
                        toastMessage(WonCouponDetailListActivity.this, getResources().getString(R.string.error_found));
                    }
            ...
            public void onFailure(Call<LoginResponse> call, Throwable t) {
                ...
                toastMessage(WonCouponDetailListActivity.this, t.getMessage());
                hideLoadingPopup();
            }
        });
    }
    ...
    {
        newActivity(new WonCouponDetailActivity(),Id,evssahibi,konuktakım,macsaati,yorum,tahmin,iddakodu,mactipi,kuponad);
    }
}
