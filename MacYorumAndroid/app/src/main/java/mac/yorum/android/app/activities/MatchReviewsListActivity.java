...
public class MatchReviewsListActivity extends  BaseAppCompatActivitiy
{
    ...
    protected void onResume()
    {
        ...
        {
            GetList(findTextViewById(R.id.txt_date).getText().toString(),findTextViewById(R.id.txt_search).getText().toString());
        }
        else
        {
            String curDate = getCurrentDate();
            findTextViewById(R.id.txt_date).setText(curDate);
            GetList(curDate,findTextViewById(R.id.txt_search).getText().toString());
        }
        super.onResume();
    }
    ...
    private void GetList(final String currentDate,final String searchText)
    {
        showLoadingPopup();
        ...
        Call<LoginResponse> servicecall = apiservice.MacYorumListe(Constants.API_KEY,Token, "text/json;charset=UTF-8", currentDate,searchText);
    ...
    public class mDateSetListener implements DatePickerDialog.OnDateSetListener {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            GetList(formattedDate,findTextViewById(R.id.txt_search).getText().toString());
        }
    }
